...
class data():
    ...
    def set_tables(self, used_engine: Engine, create=True):
        ...
        self.peer = Table("peer", metadata,
                          Column("submit_id", Integer, ForeignKey(
                              "submit.id", ondelete="CASCADE"), index=True, nullable=False),

                          Column("reciever_id", Integer, ForeignKey(
                              "account.id", ondelete="CASCADE"), index=True, nullable=False),
                          Column("reviewer_id", Integer, ForeignKey("account.id",
    ...
    from ._comment_service import insert_comment, select_comments, update_comment, insert_comment_dict
